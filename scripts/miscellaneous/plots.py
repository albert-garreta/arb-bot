...
# RESERVE01, RESERVE11 = (9833810658834961590600935, 20421014350006000000000000)
# RESERVE00, RESERVE10 = (20421014350006000000000000, 88074309589147000000000000)
...
def plot_final_profits():
    ...
    opt = get_optimal_amount_in(*args, 20 * 1e21)
    print(f(19e21) / 1e18)
    print(opt)
...
def plot_final_profits_2():
    ...
    for _ in range(5):
        amounts_in_rndn += [(x[0], 2 * _) for x in amounts_in_rndn]
    amounts_out = []
    args = (
        (RESERVE00, RESERVE10),
        (RESERVE01, RESERVE11),
    ...
    for x, y in amounts_in_rndn:
        ...
        # amounts_out.append(final_profit_ratio**2)
        amounts_out.append(final_amount_out / 1e18)
    opt = get_optimal_amount_in_2(*args)
    # print(f(19e21) / 1e18)
    print("Optimal amount", opt / 1e18, f(opt) / 1e18)
